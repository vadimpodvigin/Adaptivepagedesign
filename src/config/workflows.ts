/**
 * Map of workflow names to their JSON/YAML URLs
 */
export const workflowJsonUrls: Record<string, string> = {
  "Digital Assets":
  ...
  "BNPL":
    "https://raw.githubusercontent.com/vadimpodvigin/Corelgnite_test/refs/heads/main/YAML/BNPL.yaml",
