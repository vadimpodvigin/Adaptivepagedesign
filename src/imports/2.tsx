import svgPaths from "./svg-qxvrhvh7r3";
...
function Button1() {
  return (
    <div className="absolute bg-[#7a23d9] content-stretch flex flex-col items-start left-[700px] overflow-clip top-[625px]" data-name="Button">
      <ButtonContent1 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[32px] items-center justify-center px-[8px] py-0 relative rounded-[100px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#7a23d9] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="flex flex-col font-['IBM_Plex_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#7a23d9] text-[20px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">2.1</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full">
      <div className="basis-0 flex flex-col font-['IBM_Plex_Sans:Medium',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[24px]">
        <p className="leading-[normal]">Hogan Lookup Account</p>
      </div>
      <Frame1 />
    </div>
  );
...
function Frame4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[16px] items-start left-[120px] p-[24px] rounded-[8px] top-[387px] w-[795px]">
      <Frame7 />
      <div className="bg-[#ededed] h-px shrink-0 w-full" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-neutral-600 w-full">Morbi eleifend purus purus, a tempus arcu laoreet vel. Donec posuere ac eros in vestibulum. In eget mi eget eros molestie eleifend. Etiam condimentum lorem vitae nunc convallis hendrerit. Morbi a suscipit urna. Aenean consectetur condimentum orci a vehicula. Maecenas semper dolor tincidunt, commodo libero rhoncus, dapibus nunc. Curabitur id aliquam lorem. Suspendisse fringilla nulla odio, et finibus justo ultricies in.</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[32px] items-center justify-center px-[8px] py-0 relative rounded-[100px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#7a23d9] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="flex flex-col font-['IBM_Plex_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#7a23d9] text-[20px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">2.2</p>
      </div>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      <div className="basis-0 flex flex-col font-['IBM_Plex_Sans:Medium',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[24px]">
        <p className="leading-[normal] mb-0">Hogan Lookup Account</p>
        <p className="leading-[normal]">
          (<span className="font-['IBM_Plex_Sans:Medium',sans-serif] not-italic">Hogan Core Container</span>)
        </p>
      </div>
      <Frame2 />
    </div>
...
function Frame5() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[16px] h-[230px] items-start left-[931px] p-[24px] rounded-[8px] top-[387px] w-[389px]">
      <Frame8 />
      <div className="bg-[#ededed] h-px shrink-0 w-full" />
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-neutral-600 w-full">{`Aenean consectetur condimentum orci a vehicula. Maecenas semper dolor tincidunt, commodo libero rhoncus, dapibus nunc. `}</p>
    </div>
  );
}
...
function ArrowDown() {
  return (
    <div className="absolute left-[708px] size-[24px] top-[347px]" data-name="Arrow--down">
      <div className="absolute inset-0" style={{ "--fill-0": "rgba(255, 255, 255, 1)" } as React.CSSProperties}>
...
export default function Component() {
  return (
    <div className="bg-[rgba(255,255,255,0.95)] relative size-full" data-name="2">
